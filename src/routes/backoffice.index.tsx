...
export const Route = createFileRoute("/backoffice/")({
  head: () => ({
    meta: [
      { title: "Tableau de bord — Back-Office ARCONDIS" },
      { name: "description", content: "Indicateurs opérationnels et financiers ARCONDIS en temps réel." },
      { property: "og:title", content: "Tableau de bord ARCONDIS" },
      { property: "og:description", content: "Indicateurs opérationnels et financiers ARCONDIS." },
    ],
  }),
  component: Dashboard,
});
